...
Namespace Lookups
    ...
    Public NotInheritable Class tblMailStatus

#Region "Fields"

        Private m_intrecordid_databaseid? As Int32
        Private m_lblmailstatusinformation As String
        ...
        Private m_lblmailstatusrecordinformation As String
...
#Region "Properties"
        ...
        ''' <summary>
        ''' The lblMailStatusInformation column is in the DB
        ''' </summary>
        Public Property lblMailStatusInformation() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_lblmailstatusinformation) Then
                    Return String.Empty
                Else
                    Return m_lblmailstatusinformation
                End If
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value As String)
                If value Is Nothing Then
                    value = String.Empty
                End If
                If m_lblmailstatusinformation <> value Then
                    m_lblmailstatusinformation = value
                End If
            End Set
        End Property
        ...
        ''' <summary>
        ''' The lblMailStatusRecordInformation column is in the DB
        ''' </summary>
        Public Property lblMailStatusRecordInformation() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_lblmailstatusrecordinformation) Then
                    Return String.Empty
                Else
                    Return m_lblmailstatusrecordinformation
                End If
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value As String)
                If value Is Nothing Then
                    value = String.Empty
                End If
                If m_lblmailstatusrecordinformation <> value Then
                    m_lblmailstatusrecordinformation = value
                End If
            End Set
        End Property
...
#Region "Constructors"
        ...
        Public Sub New()
            ...
            m_lblmailstatusinformation = String.Empty
            ...
            m_lblmailstatusrecordinformation = String.Empty
...
#Region "Methods"
        ...
        Public Sub Load(ByVal sdr As OleDbDataReader)
            ...
            End If
            If Not System.Convert.IsDBNull(sdr("lblMailStatusInformation")) Then
                m_lblmailstatusinformation = sdr.GetString(sdr.GetOrdinal("lblMailStatusInformation"))
            End If
            ...
            End If
            If Not System.Convert.IsDBNull(sdr("lblMailStatusRecordInformation")) Then
                m_lblmailstatusrecordinformation = sdr.GetString(sdr.GetOrdinal("lblMailStatusRecordInformation"))
            End If
        ...
        Public Overrides Function ToString() As String
            ...
            retValue.Append(" lblMailStatusInformation = """)
            retValue.Append(m_lblmailstatusinformation)
            retValue.Append("""" & ControlChars.Lf)
            ...
            retValue.Append("""" & ControlChars.Lf)
            retValue.Append(" lblMailStatusRecordInformation = """)
            retValue.Append(m_lblmailstatusrecordinformation)
            retValue.Append("""" & ControlChars.Lf)
...
#Region "Shared Methods"
        ...
        Public Shared Function SelectByID(ByVal intrecordid As Int32) As tblMailStatus
            If intrecordid <= 0 OrElse intrecordid >= Int32.MaxValue Then
                Return Nothing
            End If

            Dim obj As tblMailStatus = Nothing

            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    Dim sql As New StringBuilder()

                    sql.Append("Select * From [dbo].[tblMailStatus] Where [intRecordID] = ? ")
        ...
        Public Shared Function SelectNextID() As Integer
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("Select MAX([intRecordID]) FROM [dbo].[tblMailStatus] ")
        ...
        Public Shared Function CreateNew(ByVal obj As tblMailStatus) As Boolean
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("INSERT INTO [tblMailStatus] (")
                    sql.Append("[intRecordID_DatabaseID], ")
                    sql.Append("[lblMailStatusInformation], [ixtCode], [txtDescription], [txtElectronicDataExchangeCode], ")
                    sql.Append("[lblCalendarReminder], [dteFollowUpDate], [txtEventStartTime], [txtEventEndTime], ")
                    sql.Append("[lblMailStatusRecordInformation], [blnMakePrivate], [blnActive], [txtRecordCreationUser], ")
                    ...
                    sql.Append("[txtRecordUpdateUser], [blnWebSearch], [blnEcommerceTransmit], [blnSecurity], ")
                    sql.Append("[dteRecordSynchronization], [blnErrorLog], [txtFieldValueGenerator], [blnSystemRecord], ")
                    sql.Append("[blnAuditTrail], [txtGUID], [blnFavorite])")
                    sql.Append("VALUES 	(")
                    sql.Append("?, ")
                    sql.Append("?, ?, ?, ?, ")
                    sql.Append("?, ?, ?, ?, ")
                    ...
                    Using cm As OleDbCommand = cn.CreateCommand()
                        ...
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.lblMailStatusInformation))
                        ...
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.lblMailStatusRecordInformation))
        ...
        Public Shared Function Update(ByVal obj As tblMailStatus) As Boolean
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("UPDATE [dbo].[tblMailStatus] SET ")
                    sql.Append("[intRecordID_DatabaseID] = ?, ")
                    sql.Append("[lblMailStatusInformation] = ?, ")
                    sql.Append("[ixtCode] = ?, ")
                    ...
                    sql.Append("[lblMailStatusRecordInformation] = ?, ")
        ...
        Public Shared Function Delete(ByVal obj As tblMailStatus) As Boolean
            If obj Is Nothing OrElse obj.intRecordID <= 0 OrElse obj.intRecordID >= Int32.MaxValue Then
                Return False
            End If
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("DELETE [dbo].[tblMailStatus] WHERE [intRecordID] = ?")
