...
Namespace Lookups
    ...
    Public NotInheritable Class tblMailType

#Region "Fields"

        Private m_intrecordid_databaseid? As Int32
        Private m_lblmailtypeinformation As String
        ...
        Private m_lblmailtyperecordinformation As String
...
#Region "Properties"
        ...
        ''' <summary>
        ''' The lblMailTypeInformation column is in the DB
        ''' </summary>
        Public Property lblMailTypeInformation() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_lblmailtypeinformation) Then
                    Return String.Empty
                Else
                    Return m_lblmailtypeinformation
                End If
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value As String)
                If value Is Nothing Then
                    value = String.Empty
                End If
                If m_lblmailtypeinformation <> value Then
                    m_lblmailtypeinformation = value
                End If
            End Set
        End Property
        ...
        ''' <summary>
        ''' The lblMailTypeRecordInformation column is in the DB
        ''' </summary>
        Public Property lblMailTypeRecordInformation() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_lblmailtyperecordinformation) Then
                    Return String.Empty
                Else
                    Return m_lblmailtyperecordinformation
                End If
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value As String)
                If value Is Nothing Then
                    value = String.Empty
                End If
                If m_lblmailtyperecordinformation <> value Then
                    m_lblmailtyperecordinformation = value
                End If
            End Set
        End Property
...
#Region "Constructors"
        ...
        Public Sub New()
            ...
            m_lblmailtypeinformation = String.Empty
            ...
            m_lblmailtyperecordinformation = String.Empty
...
#Region "Methods"
        ...
        Public Sub Load(ByVal sdr As OleDbDataReader)
            ...
            End If
            If Not System.Convert.IsDBNull(sdr("lblMailTypeInformation")) Then
                m_lblmailtypeinformation = sdr.GetString(sdr.GetOrdinal("lblMailTypeInformation"))
            End If
            ...
            End If
            If Not System.Convert.IsDBNull(sdr("lblMailTypeRecordInformation")) Then
                m_lblmailtyperecordinformation = sdr.GetString(sdr.GetOrdinal("lblMailTypeRecordInformation"))
            End If
        ...
        Public Overrides Function ToString() As String
            ...
            retValue.Append(" lblMailTypeInformation = """)
            retValue.Append(m_lblmailtypeinformation)
            retValue.Append("""" & ControlChars.Lf)
            ...
            retValue.Append("""" & ControlChars.Lf)
            retValue.Append(" lblMailTypeRecordInformation = """)
            retValue.Append(m_lblmailtyperecordinformation)
            retValue.Append("""" & ControlChars.Lf)
...
#Region "Shared Methods"
        ...
        Public Shared Function SelectByID(ByVal intrecordid As Int32) As tblMailType
            If intrecordid <= 0 OrElse intrecordid >= Int32.MaxValue Then
                Return Nothing
            End If

            Dim obj As tblMailType = Nothing

            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    Dim sql As New StringBuilder()

                    sql.Append("Select * From [dbo].[tblMailType] Where [intRecordID] = ? ")
        ...
        Public Shared Function SelectNextID() As Integer
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("Select MAX([intRecordID]) FROM [dbo].[tblMailType] ")
        ...
        Public Shared Function CreateNew(ByVal obj As tblMailType) As Boolean
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("INSERT INTO [tblMailType] (")
                    sql.Append("[intRecordID_DatabaseID], ")
                    sql.Append("[lblMailTypeInformation], [ixtCode], [txtDescription], [decMaxNumberOfCharacters], ")
                    sql.Append("[txtElectronicDataExchangeCode], [lblCalendarReminder], [dteFollowUpDate], [txtEventStartTime], ")
                    sql.Append("[txtEventEndTime], [lblMailTypeRecordInformation], [blnMakePrivate], [blnActive], ")
                    ...
                    Using cm As OleDbCommand = cn.CreateCommand()
                        ...
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.lblMailTypeInformation))
                        ...
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.lblMailTypeRecordInformation))
        ...
        Public Shared Function Update(ByVal obj As tblMailType) As Boolean
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("UPDATE [dbo].[tblMailType] SET ")
                    sql.Append("[intRecordID_DatabaseID] = ?, ")
                    sql.Append("[lblMailTypeInformation] = ?, ")
                    sql.Append("[ixtCode] = ?, ")
                    ...
                    sql.Append("[lblMailTypeRecordInformation] = ?, ")
        ...
        Public Shared Function Delete(ByVal obj As tblMailType) As Boolean
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("DELETE [dbo].[tblMailType] WHERE [intRecordID] = ?")
