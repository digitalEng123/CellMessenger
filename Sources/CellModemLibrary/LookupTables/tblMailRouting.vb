...
Namespace Lookups
    ...
    Public NotInheritable Class tblMailRouting

#Region "Fields"

        Private m_intrecordid_databaseid? As Int32
        Private m_lblmailroutinginformation As String
        ...
        Private m_lblmailroutingrecordinformation As String
...
#Region "Properties"
        ...
        ''' <summary>
        ''' The lblMailRoutingInformation column is in the DB
        ''' </summary>
        Public Property lblMailRoutingInformation() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_lblmailroutinginformation) Then
                    Return String.Empty
                Else
                    Return m_lblmailroutinginformation
                End If
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value As String)
                If value Is Nothing Then
                    value = String.Empty
                End If
                If m_lblmailroutinginformation <> value Then
                    m_lblmailroutinginformation = value
                End If
            End Set
        End Property
        ...
        ''' <summary>
        ''' The lblMailRoutingRecordInformation column is in the DB
        ''' </summary>
        Public Property lblMailRoutingRecordInformation() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_lblmailroutingrecordinformation) Then
                    Return String.Empty
                Else
                    Return m_lblmailroutingrecordinformation
                End If
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value As String)
                If value Is Nothing Then
                    value = String.Empty
                End If
                If m_lblmailroutingrecordinformation <> value Then
                    m_lblmailroutingrecordinformation = value
                End If
            End Set
        End Property
...
#Region "Constructors"
        ...
        Public Sub New()
            ...
            m_lblmailroutinginformation = String.Empty
            ...
            m_lblmailroutingrecordinformation = String.Empty
...
#Region "Methods"
        ...
        Public Sub Load(ByVal sdr As OleDbDataReader)
            ...
            End If
            If Not System.Convert.IsDBNull(sdr("lblMailRoutingInformation")) Then
                m_lblmailroutinginformation = sdr.GetString(sdr.GetOrdinal("lblMailRoutingInformation"))
            End If
            ...
            End If
            If Not System.Convert.IsDBNull(sdr("lblMailRoutingRecordInformation")) Then
                m_lblmailroutingrecordinformation = sdr.GetString(sdr.GetOrdinal("lblMailRoutingRecordInformation"))
            End If
        ...
        Public Overrides Function ToString() As String
            ...
            retValue.Append(" lblMailRoutingInformation = """)
            retValue.Append(m_lblmailroutinginformation)
            retValue.Append("""" & ControlChars.Lf)
            ...
            retValue.Append("""" & ControlChars.Lf)
            retValue.Append(" lblMailRoutingRecordInformation = """)
            retValue.Append(m_lblmailroutingrecordinformation)
            retValue.Append("""" & ControlChars.Lf)
...
#Region "Shared Methods"
        ...
        Public Shared Function SelectByID(ByVal intrecordid As Int32) As tblMailRouting
            If intrecordid <= 0 OrElse intrecordid >= Int32.MaxValue Then
                Return Nothing
            End If

            Dim obj As tblMailRouting = Nothing

            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    Dim sql As New StringBuilder()

                    sql.Append("Select * From [dbo].[tblMailRouting] Where [intRecordID] = ? ")
        ...
        Public Shared Function SelectNextID() As Integer
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("Select MAX([intRecordID]) FROM [dbo].[tblMailRouting] ")
        ...
        Public Shared Function CreateNew(ByVal obj As tblMailRouting) As Boolean
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("INSERT INTO [tblMailRouting] (")
                    sql.Append("[intRecordID_DatabaseID], ")
                    sql.Append("[lblMailRoutingInformation], [ixtCode], [txtDescription], [txtElectronicDataExchangeCode], ")
                    sql.Append("[lblCalendarReminder], [dteFollowUpDate], [txtEventStartTime], [txtEventEndTime], ")
                    sql.Append("[lblMailRoutingRecordInformation], [blnMakePrivate], [blnActive], [txtRecordCreationUser], ")
                    ...
                    Using cm As OleDbCommand = cn.CreateCommand()
                        ...
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.lblMailRoutingInformation))
                        ...
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.lblMailRoutingRecordInformation))
        ...
        Public Shared Function Update(ByVal obj As tblMailRouting) As Boolean
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("UPDATE [dbo].[tblMailRouting] SET ")
                    sql.Append("[intRecordID_DatabaseID] = ?, ")
                    sql.Append("[lblMailRoutingInformation] = ?, ")
                    sql.Append("[ixtCode] = ?, ")
                    ...
                    sql.Append("[lblMailRoutingRecordInformation] = ?, ")
        ...
        Public Shared Function Delete(ByVal obj As tblMailRouting) As Boolean
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("DELETE [dbo].[tblMailRouting] WHERE [intRecordID] = ?")
