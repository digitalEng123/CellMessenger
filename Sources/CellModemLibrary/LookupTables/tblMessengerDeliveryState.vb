...
Namespace Lookups
    ...
    Public NotInheritable Class tblMessengerDeliveryState

#Region "Fields"

        Private m_intrecordid_databaseid? As Int32
        Private m_lblmessengerdeliverystateinformation As String
        ...
        Private m_lblmessengerdeliverystaterecordinformation As String
...
#Region "Properties"
        ...
        ''' <summary>
        ''' The lblMessengerDeliveryStateInformation column is in the DB
        ''' </summary>
        Public Property lblMessengerDeliveryStateInformation() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_lblmessengerdeliverystateinformation) Then
                    Return String.Empty
                Else
                    Return m_lblmessengerdeliverystateinformation
                End If
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value As String)
                If value Is Nothing Then
                    value = String.Empty
                End If
                If m_lblmessengerdeliverystateinformation <> value Then
                    m_lblmessengerdeliverystateinformation = value
                End If
            End Set
        End Property
        ...
        ''' <summary>
        ''' The lblMessengerDeliveryStateRecordInformation column is in the DB
        ''' </summary>
        Public Property lblMessengerDeliveryStateRecordInformation() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_lblmessengerdeliverystaterecordinformation) Then
                    Return String.Empty
                Else
                    Return m_lblmessengerdeliverystaterecordinformation
                End If
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value As String)
                If value Is Nothing Then
                    value = String.Empty
                End If
                If m_lblmessengerdeliverystaterecordinformation <> value Then
                    m_lblmessengerdeliverystaterecordinformation = value
                End If
            End Set
        End Property
...
#Region "Constructors"
        ...
        Public Sub New()
            ...
            m_lblmessengerdeliverystateinformation = String.Empty
            ...
            m_lblmessengerdeliverystaterecordinformation = String.Empty
...
#Region "Methods"
        ...
        Public Sub Load(ByVal sdr As OleDbDataReader)
            ...
            End If
            If Not System.Convert.IsDBNull(sdr("lblMessengerDeliveryStateInformation")) Then
                m_lblmessengerdeliverystateinformation = sdr.GetString(sdr.GetOrdinal("lblMessengerDeliveryStateInformation"))
            End If
            ...
            End If
            If Not System.Convert.IsDBNull(sdr("lblMessengerDeliveryStateRecordInformation")) Then
                m_lblmessengerdeliverystaterecordinformation = sdr.GetString(sdr.GetOrdinal("lblMessengerDeliveryStateRecordInformation"))
            End If
        ...
        Public Overrides Function ToString() As String
            ...
            retValue.Append(" lblMessengerDeliveryStateInformation = """)
            retValue.Append(m_lblmessengerdeliverystateinformation)
            retValue.Append("""" & ControlChars.Lf)
            ...
            retValue.Append("""" & ControlChars.Lf)
            retValue.Append(" lblMessengerDeliveryStateRecordInformation = """)
            retValue.Append(m_lblmessengerdeliverystaterecordinformation)
            retValue.Append("""" & ControlChars.Lf)
...
#Region "Shared Methods"
        ...
        Public Shared Function SelectByID(ByVal intrecordid As Int32) As tblMessengerDeliveryState
            If intrecordid <= 0 OrElse intrecordid >= Int32.MaxValue Then
                Return Nothing
            End If

            Dim obj As tblMessengerDeliveryState = Nothing

            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    Dim sql As New StringBuilder()

                    sql.Append("Select * From [dbo].[tblMessengerDeliveryState] Where [intRecordID] = ? ")
                    ...
                    Using cm As OleDbCommand = cn.CreateCommand()
                        ...
                        Using sdr As OleDbDataReader = cm.ExecuteReader()
                            Do While sdr.Read()
                                obj = New tblMessengerDeliveryState()
        ...
        Public Shared Function SelectNextID() As Integer
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("Select MAX([intRecordID]) FROM [dbo].[tblMessengerDeliveryState] ")
        ...
        Public Shared Function CreateNew(ByVal obj As tblMessengerDeliveryState) As Boolean
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("INSERT INTO [tblMessengerDeliveryState] (")
                    sql.Append("[intRecordID_DatabaseID], ")
                    sql.Append("[lblMessengerDeliveryStateInformation], [ixtCode], [txtDescription], [txtElectronicDataExchangeCode], ")
                    sql.Append("[lblCalendarReminder], [dteFollowUpDate], [txtEventStartTime], [txtEventEndTime], ")
                    sql.Append("[lblMessengerDeliveryStateRecordInformation], [blnMakePrivate], [blnActive], [txtRecordCreationUser], ")
                    ...
                    Using cm As OleDbCommand = cn.CreateCommand()
                        ...
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.lblMessengerDeliveryStateInformation))
                        ...
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.lblMessengerDeliveryStateRecordInformation))
        ...
        Public Shared Function Update(ByVal obj As tblMessengerDeliveryState) As Boolean
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("UPDATE [dbo].[tblMessengerDeliveryState] SET ")
                    sql.Append("[intRecordID_DatabaseID] = ?, ")
                    sql.Append("[lblMessengerDeliveryStateInformation] = ?, ")
                    sql.Append("[ixtCode] = ?, ")
                    ...
                    sql.Append("[lblMessengerDeliveryStateRecordInformation] = ?, ")
        ...
        Public Shared Function Delete(ByVal obj As tblMessengerDeliveryState) As Boolean
            If obj Is Nothing OrElse obj.intRecordID <= 0 OrElse obj.intRecordID >= Int32.MaxValue Then
                Return False
            End If
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("DELETE [dbo].[tblMessengerDeliveryState] WHERE [intRecordID] = ?")
