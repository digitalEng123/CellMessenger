...
Namespace Configuration
    ...
    Public NotInheritable Class tblMessengerCommunicationProvider

#Region "Fields"

        Private m_intrecordid_databaseid? As Int32
        Private m_lblmessengercommunicationprovider As String
        Private m_ixtcode As String
        Private m_txtdescription As String
        Private m_intrecordid_messengeragentconfig? As Int32
        Private m_lblmessengercommunicationproviderconfiguration As String
        Private m_txtusername As String
        Private m_txtpassword As String
        Private m_txtaccountid As String
        Private m_txtsubaccountid As String
        Private m_txtuserid As String
        Private m_txtapitoken As String
        Private m_txtapisecretkey As String
        Private m_mmologinurlwic As String
        Private m_dteaccountrequestexpirationdate? As Date
        Private m_lbmrequiredforsmsattachmentfunctionality As String
        Private m_lbmmustbepublicaccessibleurl As String
        Private m_mmoproviderattachmentcallbackurl As String
        ...
        Private m_lblmessengercommunicationproviderinformation As String
...
#Region "Properties"
        ...
        ''' <summary>
        ''' The lblMessengerCommunicationProvider column is in the DB
        ''' </summary>
        Public Property lblMessengerCommunicationProvider() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_lblmessengercommunicationprovider) Then
                    Return String.Empty
                Else
                    Return m_lblmessengercommunicationprovider
                End If
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value As String)
                If value Is Nothing Then
                    value = String.Empty
                End If
                If m_lblmessengercommunicationprovider <> value Then
                    m_lblmessengercommunicationprovider = value
                End If
            End Set
        End Property
        ...
        ''' <summary>
        ''' The intRecordID_MessengerAgentConfig column is in the DB
        ''' </summary>
        Public Property intRecordID_MessengerAgentConfig() As Int32?
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                Return m_intrecordid_messengeragentconfig
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value? As Int32)
                If Not m_intrecordid_messengeragentconfig.Equals(value) Then
                    m_intrecordid_messengeragentconfig = value
                End If
            End Set
        End Property

        ''' <summary>
        ''' The lblMessengerCommunicationProviderConfiguration column is in the DB
        ''' </summary>
        Public Property lblMessengerCommunicationProviderConfiguration() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_lblmessengercommunicationproviderconfiguration) Then
                    Return String.Empty
                Else
                    Return m_lblmessengercommunicationproviderconfiguration
                End If
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value As String)
                If value Is Nothing Then
                    value = String.Empty
                End If
                If m_lblmessengercommunicationproviderconfiguration <> value Then
                    m_lblmessengercommunicationproviderconfiguration = value
                End If
            End Set
        End Property
        ...
        ''' <summary>
        ''' The txtAccountID column is in the DB
        ''' </summary>
        Public Property txtAccountID() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_txtaccountid) Then
                    Return String.Empty
                Else
                    Return m_txtaccountid
                End If
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value As String)
                If value Is Nothing Then
                    value = String.Empty
                End If
                If m_txtaccountid <> value Then
                    m_txtaccountid = value
                End If
            End Set
        End Property

        ''' <summary>
        ''' The txtSubAccountID column is in the DB
        ''' </summary>
        Public Property txtSubAccountID() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_txtsubaccountid) Then
                    Return String.Empty
                Else
                    Return m_txtsubaccountid
                End If
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value As String)
                If value Is Nothing Then
                    value = String.Empty
                End If
                If m_txtsubaccountid <> value Then
                    m_txtsubaccountid = value
                End If
            End Set
        End Property

        ''' <summary>
        ''' The txtUserID column is in the DB
        ''' </summary>
        Public Property txtUserID() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_txtuserid) Then
                    Return String.Empty
                Else
                    Return m_txtuserid
                End If
        ...
        ''' <summary>
        ''' The txtAPIToken column is in the DB
        ''' </summary>
        Public Property txtAPIToken() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_txtapitoken) Then
                    Return String.Empty
                Else
                    Return m_txtapitoken
                End If
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value As String)
        ...
        ''' <summary>
        ''' The txtAPISecretKey column is in the DB
        ''' </summary>
        Public Property txtAPISecretKey() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_txtapisecretkey) Then
                    Return String.Empty
                Else
                    Return m_txtapisecretkey
                End If
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value As String)
                If value Is Nothing Then
                    value = String.Empty
                End If
                If m_txtapisecretkey <> value Then
                    m_txtapisecretkey = value
                End If
            End Set
        End Property

        ''' <summary>
        ''' The mmoLoginUrlWIC column is in the DB
        ''' </summary>
        Public Property mmoLoginUrlWIC() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_mmologinurlwic) Then
                    Return String.Empty
                Else
                    Return m_mmologinurlwic
                End If
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value As String)
                If value Is Nothing Then
                    value = String.Empty
                End If
                If m_mmologinurlwic <> value Then
                    m_mmologinurlwic = value
                End If
            End Set
        End Property

        ''' <summary>
        ''' The dteAccountRequestExpirationDate column is in the DB
        ''' </summary>
        Public Property dteAccountRequestExpirationDate() As Date?
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                Return m_dteaccountrequestexpirationdate
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value? As Date)
                If Not m_dteaccountrequestexpirationdate.Equals(value) Then
                    m_dteaccountrequestexpirationdate = value
                End If
            End Set
        End Property

        ''' <summary>
        ''' The lbmRequiredForSMSAttachmentFunctionality column is in the DB
        ''' </summary>
        Public Property lbmRequiredForSMSAttachmentFunctionality() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_lbmrequiredforsmsattachmentfunctionality) Then
                    Return String.Empty
                Else
                    Return m_lbmrequiredforsmsattachmentfunctionality
                End If
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value As String)
                If value Is Nothing Then
                    value = String.Empty
                End If
                If m_lbmrequiredforsmsattachmentfunctionality <> value Then
                    m_lbmrequiredforsmsattachmentfunctionality = value
                End If
            End Set
        End Property

        ''' <summary>
        ''' The lbmMustBePublicAccessibleURL column is in the DB
        ''' </summary>
        Public Property lbmMustBePublicAccessibleURL() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_lbmmustbepublicaccessibleurl) Then
                    Return String.Empty
                Else
                    Return m_lbmmustbepublicaccessibleurl
                End If
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value As String)
                If value Is Nothing Then
                    value = String.Empty
                End If
                If m_lbmmustbepublicaccessibleurl <> value Then
                    m_lbmmustbepublicaccessibleurl = value
                End If
            End Set
        End Property

        ''' <summary>
        ''' The mmoProviderAttachmentCallbackURL column is in the DB
        ''' </summary>
        Public Property mmoProviderAttachmentCallbackURL() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_mmoproviderattachmentcallbackurl) Then
                    Return String.Empty
                Else
                    Return m_mmoproviderattachmentcallbackurl
                End If
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value As String)
                If value Is Nothing Then
                    value = String.Empty
                End If
                If m_mmoproviderattachmentcallbackurl <> value Then
                    m_mmoproviderattachmentcallbackurl = value
                End If
            End Set
        End Property
        ...
        ''' <summary>
        ''' The lblMessengerCommunicationProviderInformation column is in the DB
        ''' </summary>
        Public Property lblMessengerCommunicationProviderInformation() As String
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Get
                If String.IsNullOrEmpty(m_lblmessengercommunicationproviderinformation) Then
                    Return String.Empty
                Else
                    Return m_lblmessengercommunicationproviderinformation
                End If
            End Get
            <System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.NoInlining)>
            Set(ByVal value As String)
                If value Is Nothing Then
                    value = String.Empty
                End If
                If m_lblmessengercommunicationproviderinformation <> value Then
                    m_lblmessengercommunicationproviderinformation = value
                End If
            End Set
        End Property
...
#Region "Constructors"
        ...
        Public Sub New()
            ...
            m_lblmessengercommunicationprovider = String.Empty
            m_ixtcode = String.Empty
            m_txtdescription = String.Empty
            m_intrecordid_messengeragentconfig = Nothing
            m_lblmessengercommunicationproviderconfiguration = String.Empty
            m_txtusername = String.Empty
            m_txtpassword = String.Empty
            m_txtaccountid = String.Empty
            m_txtsubaccountid = String.Empty
            m_txtuserid = String.Empty
            m_txtapitoken = String.Empty
            m_txtapisecretkey = String.Empty
            m_mmologinurlwic = String.Empty
            m_dteaccountrequestexpirationdate = Nothing
            m_lbmrequiredforsmsattachmentfunctionality = String.Empty
            m_lbmmustbepublicaccessibleurl = String.Empty
            m_mmoproviderattachmentcallbackurl = String.Empty
            ...
            m_lblmessengercommunicationproviderinformation = String.Empty
...
#Region "Methods"
        ...
        Public Sub Load(ByVal sdr As OleDbDataReader)
            ...
            End If
            If Not System.Convert.IsDBNull(sdr("lblMessengerCommunicationProvider")) Then
                m_lblmessengercommunicationprovider = sdr.GetString(sdr.GetOrdinal("lblMessengerCommunicationProvider"))
            End If
            ...
            End If
            If Not System.Convert.IsDBNull(sdr("intRecordID_MessengerAgentConfig")) Then
                m_intrecordid_messengeragentconfig = sdr.GetInt32(sdr.GetOrdinal("intRecordID_MessengerAgentConfig"))
            End If
            If Not System.Convert.IsDBNull(sdr("lblMessengerCommunicationProviderConfiguration")) Then
                m_lblmessengercommunicationproviderconfiguration = sdr.GetString(sdr.GetOrdinal("lblMessengerCommunicationProviderConfiguration"))
            End If
            ...
            End If
            If Not System.Convert.IsDBNull(sdr("txtAccountID")) Then
                m_txtaccountid = sdr.GetString(sdr.GetOrdinal("txtAccountID"))
            End If
            If Not System.Convert.IsDBNull(sdr("txtSubAccountID")) Then
                m_txtsubaccountid = sdr.GetString(sdr.GetOrdinal("txtSubAccountID"))
            End If
            If Not System.Convert.IsDBNull(sdr("txtUserID")) Then
                m_txtuserid = sdr.GetString(sdr.GetOrdinal("txtUserID"))
            End If
            If Not System.Convert.IsDBNull(sdr("txtAPIToken")) Then
                m_txtapitoken = sdr.GetString(sdr.GetOrdinal("txtAPIToken"))
            End If
            If Not System.Convert.IsDBNull(sdr("txtAPISecretKey")) Then
                m_txtapisecretkey = sdr.GetString(sdr.GetOrdinal("txtAPISecretKey"))
            End If
            If Not System.Convert.IsDBNull(sdr("mmoLoginUrlWIC")) Then
                m_mmologinurlwic = sdr.GetString(sdr.GetOrdinal("mmoLoginUrlWIC"))
            End If
            If Not System.Convert.IsDBNull(sdr("dteAccountRequestExpirationDate")) Then
                m_dteaccountrequestexpirationdate = sdr.GetDateTime(sdr.GetOrdinal("dteAccountRequestExpirationDate"))
            End If
            If Not System.Convert.IsDBNull(sdr("lbmRequiredForSMSAttachmentFunctionality")) Then
                m_lbmrequiredforsmsattachmentfunctionality = sdr.GetString(sdr.GetOrdinal("lbmRequiredForSMSAttachmentFunctionality"))
            End If
            If Not System.Convert.IsDBNull(sdr("lbmMustBePublicAccessibleURL")) Then
                m_lbmmustbepublicaccessibleurl = sdr.GetString(sdr.GetOrdinal("lbmMustBePublicAccessibleURL"))
            End If
            If Not System.Convert.IsDBNull(sdr("mmoProviderAttachmentCallbackURL")) Then
                m_mmoproviderattachmentcallbackurl = sdr.GetString(sdr.GetOrdinal("mmoProviderAttachmentCallbackURL"))
            End If
            ...
            End If
            If Not System.Convert.IsDBNull(sdr("lblMessengerCommunicationProviderInformation")) Then
                m_lblmessengercommunicationproviderinformation = sdr.GetString(sdr.GetOrdinal("lblMessengerCommunicationProviderInformation"))
            End If
        ...
        Public Overrides Function ToString() As String
            ...
            retValue.Append(" lblMessengerCommunicationProvider = """)
            retValue.Append(m_lblmessengercommunicationprovider)
            retValue.Append("""" & ControlChars.Lf)
            ...
            retValue.Append("""" & ControlChars.Lf)
            retValue.Append(" intRecordID_MessengerAgentConfig = """)
            retValue.Append(m_intrecordid_messengeragentconfig)
            retValue.Append("""" & ControlChars.Lf)
            retValue.Append(" lblMessengerCommunicationProviderConfiguration = """)
            retValue.Append(m_lblmessengercommunicationproviderconfiguration)
            retValue.Append("""" & ControlChars.Lf)
            ...
            retValue.Append("""" & ControlChars.Lf)
            retValue.Append(" txtAccountID = """)
            retValue.Append(m_txtaccountid)
            retValue.Append("""" & ControlChars.Lf)
            retValue.Append(" txtSubAccountID = """)
            retValue.Append(m_txtsubaccountid)
            retValue.Append("""" & ControlChars.Lf)
            retValue.Append(" txtUserID = """)
            retValue.Append(m_txtuserid)
            retValue.Append("""" & ControlChars.Lf)
            retValue.Append(" txtAPIToken = """)
            retValue.Append(m_txtapitoken)
            retValue.Append("""" & ControlChars.Lf)
            retValue.Append(" txtAPISecretKey = """)
            retValue.Append(m_txtapisecretkey)
            retValue.Append("""" & ControlChars.Lf)
            retValue.Append(" mmoLoginUrlWIC = """)
            retValue.Append(m_mmologinurlwic)
            retValue.Append("""" & ControlChars.Lf)
            retValue.Append(" dteAccountRequestExpirationDate = """)
            retValue.Append(m_dteaccountrequestexpirationdate)
            retValue.Append("""" & ControlChars.Lf)
            retValue.Append(" lbmRequiredForSMSAttachmentFunctionality = """)
            retValue.Append(m_lbmrequiredforsmsattachmentfunctionality)
            retValue.Append("""" & ControlChars.Lf)
            retValue.Append(" lbmMustBePublicAccessibleURL = """)
            retValue.Append(m_lbmmustbepublicaccessibleurl)
            retValue.Append("""" & ControlChars.Lf)
            retValue.Append(" mmoProviderAttachmentCallbackURL = """)
            retValue.Append(m_mmoproviderattachmentcallbackurl)
            retValue.Append("""" & ControlChars.Lf)
            ...
            retValue.Append("""" & ControlChars.Lf)
            retValue.Append(" lblMessengerCommunicationProviderInformation = """)
            retValue.Append(m_lblmessengercommunicationproviderinformation)
            retValue.Append("""" & ControlChars.Lf)
...
#Region "Shared Methods"
        ...
        Public Shared Function SelectByID(ByVal intrecordid As Int32) As tblMessengerCommunicationProvider
            If intrecordid <= 0 OrElse intrecordid >= Int32.MaxValue Then
                Return Nothing
            End If

            Dim obj As tblMessengerCommunicationProvider = Nothing

            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    Dim sql As New StringBuilder()

                    sql.Append("Select * From [dbo].[tblMessengerCommunicationProvider] Where [intRecordID] = ? ")
                    ...
                    Using cm As OleDbCommand = cn.CreateCommand()
                        ...
                        Using sdr As OleDbDataReader = cm.ExecuteReader()
                            Do While sdr.Read()
                                obj = New tblMessengerCommunicationProvider()
        ...
        Public Shared Function SelectByConfigurationID(ByVal intrecordid_messengerConfiguration As Int32) As tblMessengerCommunicationProvider

            If intrecordid_messengerConfiguration <= 0 OrElse intrecordid_messengerConfiguration >= Int32.MaxValue Then
                Return Nothing
            End If
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("Select t1.* From [dbo].[tblMessengerCommunicationProvider] t1 ")
                    sql.Append("inner join [dbo].[tblMessengerConfiguration] t2 on t1.[intRecordID] = t2.[intRecordID_MessengerCommunicationProvider] ")
                    sql.Append("Where t2.[intRecordID] = ? ")

                    Using cm As OleDbCommand = cn.CreateCommand()
                        cm.CommandType = CommandType.Text
                        cm.CommandText = sql.ToString()

                        cm.Parameters.AddWithValue("", intrecordid_messengerConfiguration)
        ...
        Public Shared Function SelectNextID() As Integer
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("Select MAX([intRecordID]) FROM [dbo].[tblMessengerCommunicationProvider] ")
        ...
        Public Shared Function SelectDefault() As tblMessengerCommunicationProvider
            ...
            Try
                ...
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("Select Top 1 * From [dbo].[tblMessengerCommunicationProvider] ")
        ...
        Public Shared Function CreateNew(ByVal obj As tblMessengerCommunicationProvider) As Boolean
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("INSERT INTO [tblMessengerCommunicationProvider] (")
                    sql.Append("[intRecordID_DatabaseID], ")
                    sql.Append("[lblMessengerCommunicationProvider], [ixtCode], [txtDescription], [intRecordID_MessengerAgentConfig], ")
                    sql.Append("[lblMessengerCommunicationProviderConfiguration], [txtUserName], [txtPassword], [txtAccountID], ")
                    sql.Append("[txtSubAccountID], [txtUserID], [txtAPIToken], [txtAPISecretKey], ")
                    sql.Append("[mmoLoginUrlWIC], [dteAccountRequestExpirationDate], [lbmRequiredForSMSAttachmentFunctionality], [lbmMustBePublicAccessibleURL], ")
                    sql.Append("[mmoProviderAttachmentCallbackURL], [txtElectronicDataExchangeCode], [lblCalendarReminder], ")
                    sql.Append("[dteFollowUpDate], [txtEventStartTime], [txtEventEndTime], [lblMessengerCommunicationProviderInformation], ")
                    sql.Append("[blnMakePrivate], [blnActive], [txtRecordCreationUser], [dteRecordCreationDate], ")
                    sql.Append("[dteRecordUpdateDate], [blnCursor], [intRecordID_Company], [intRecordID_Division], ")
                    sql.Append("[intRecordID], [intRecordID_User_Creation], [blnAttachment], [blnDeleted], ")
                    sql.Append("[blnHighlight], [blnMemo], [blnProcess], [blnProject], ")
                    sql.Append("[intRecordID_ErrorLog], [intRecordID_Status], [blnPrint], [txtRecordUpdateUser], ")
                    sql.Append("[dteRecordSynchronization], [blnWebSearch], [blnSecurity], [blnErrorLog], ")
                    sql.Append("[blnFavorite], [blnAuditTrail], [txtFieldValueGenerator], [blnSystemRecord], ")
                    sql.Append("[blnEcommerceTransmit], [txtGUID])")
                    sql.Append("VALUES 	(")
                    sql.Append("?, ")
                    sql.Append("?, ?, ?, ?, ")
                    sql.Append("?, ?, ?, ?, ")
                    ...
                    Using cm As OleDbCommand = cn.CreateCommand()
                        ...
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.lblMessengerCommunicationProvider))
                        ...
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.intRecordID_MessengerAgentConfig))
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.lblMessengerCommunicationProviderConfiguration))
                        ...
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.txtAccountID))
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.txtSubAccountID))
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.txtUserID))
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.txtAPIToken))
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.txtAPISecretKey))
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.mmoLoginUrlWIC))
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.dteAccountRequestExpirationDate)).OleDbType = OleDbType.Date
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.lbmRequiredForSMSAttachmentFunctionality))
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.lbmMustBePublicAccessibleURL))
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.mmoProviderAttachmentCallbackURL))
                        ...
                        cm.Parameters.AddWithValue("", SqlHelper.GetValueIfAny(obj.lblMessengerCommunicationProviderInformation))
        ...
        Public Shared Function Update(ByVal obj As tblMessengerCommunicationProvider) As Boolean
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("UPDATE [dbo].[tblMessengerCommunicationProvider] SET ")
                    sql.Append("[intRecordID_DatabaseID] = ?, ")
                    sql.Append("[lblMessengerCommunicationProvider] = ?, ")
                    sql.Append("[ixtCode] = ?, ")
                    sql.Append("[txtDescription] = ?, ")
                    sql.Append("[intRecordID_MessengerAgentConfig] = ?, ")
                    sql.Append("[lblMessengerCommunicationProviderConfiguration] = ?, ")
                    sql.Append("[txtUserName] = ?, ")
                    sql.Append("[txtPassword] = ?, ")
                    sql.Append("[txtAccountID] = ?, ")
                    sql.Append("[txtSubAccountID] = ?, ")
                    sql.Append("[txtUserID] = ?, ")
                    sql.Append("[txtAPIToken] = ?, ")
                    sql.Append("[txtAPISecretKey] = ?, ")
                    sql.Append("[mmoLoginUrlWIC] = ?, ")
                    sql.Append("[dteAccountRequestExpirationDate] = ?, ")
                    sql.Append("[lbmRequiredForSMSAttachmentFunctionality] = ?, ")
                    sql.Append("[lbmMustBePublicAccessibleURL] = ?, ")
                    sql.Append("[mmoProviderAttachmentCallbackURL] = ?, ")
                    ...
                    sql.Append("[lblMessengerCommunicationProviderInformation] = ?, ")
        ...
        Public Shared Function Delete(ByVal obj As tblMessengerCommunicationProvider) As Boolean
            If obj Is Nothing OrElse obj.intRecordID <= 0 OrElse obj.intRecordID >= Int32.MaxValue Then
                Return False
            End If
            ...
            Try
                Using cn As New OleDbConnection(DbApplication.Context.ConnString)
                    ...
                    sql.Append("DELETE [dbo].[tblMessengerCommunicationProvider] WHERE [intRecordID] = ?")
